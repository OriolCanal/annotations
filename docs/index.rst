...
VEP
---
An additional module including the detection and download of new versions of vep has been developed. This module detects the last version of vep released in dockerhub and compares with the last version of vep installed in your docker environment. If the version of the dockerhub > your docker environment version, the docker image of the new release is downloaded.
